...
{
    bool x_overlaps = (a.x < b.x + b.w) && (a.x + a.w > b.x); //check neu rectangle nam tren/nam duoi
...
bool CollisionHandler::MapCollision(SDL_Rect a)
{
    ...
    if (bottom_tile > RowCount) {bottom_tile = RowCount;} //check tile dang trc, sau, tren, duoi
